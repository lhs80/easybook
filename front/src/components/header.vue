<template>
  <b-navbar toggleable="lg" type="light" variant="white" style="border-bottom:solid 1px #f0f0f0;padding:0">
    <div class="nav-wrapper">
      <b-nav-toggle target="nav_collapse"></b-nav-toggle>
      <b-navbar-brand class="float-left" href="#" style="padding:9px 25px 15px 12px"><img src="../assets/logo.png" alt="logo" width="55px"></b-navbar-brand>
      ...
      <div class="main-nav">
        <b-collapse is-nav id="nav_collapse">
          <b-nav is-nav-bar class="col-lg-10">
            <b-nav-item href="#" class="mr-lg-4 active"><i class="jian_iconfont jian-zhinanzhen font-weight-bold h5" style="vertical-align:middle"></i> 首页</b-nav-item>
            <b-nav-item href="#" class="mr-lg-4"><i class="jian_iconfont jian-shouji font-weight-bold h5" style="vertical-align:middle"></i> 下载App</b-nav-item>
            <b-nav-form>
              <b-form-input size="sm" class="mr-sm-2" type="text" placeholder="Search"/>
              <b-button size="sm" class="my-sm-0" type="submit">搜索</b-button>
            </b-nav-form>
          </b-nav>
          <b-nav is-nav-bar class="mt-1">
            <!--字体、夜间白天模式切换-->
            <b-nav-item id="exPopoverReactive1"><i class="jian_iconfont jian-method-draw-image h4"></i></b-nav-item>
            <b-popover target="exPopoverReactive1" triggers="click" placement="auto" container="myContainer"
                       ref="popover"
                       @show="onShow"
                       @shown="onShown"
                       @hidden="onHidden">
            ...
            <b-nav-item class="text-muted">登陆</b-nav-item>
          </b-nav>
        </b-collapse>
      </div>
    </div>
